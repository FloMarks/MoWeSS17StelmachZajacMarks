...
<body>
    ...
    <div class="wrapper">
		...
		<div class="box overview_box1"></div>
				<div class="box filter_box1"><h1 id="name_box1">Berg</h1></div>
		<div class="box overview_box2"></div>
				<div class="box filter_box2"><h1 id="name_box2">Köln</h1></div>
		<div class="box overview_box3"></div>
				<div class="box filter_box3"><h1 id="name_box3">Nepal</h1></div>
		<div class="box overview_box4"></div>
				<div class="box filter_box4"><h1 id="name_box4">Maledieven</h1></div>
		<div class="box overview_box5"></div>
				<div class="box filter_box5"><h1 id="name_box5">Tokio</h1></div>
		<div class="box overview_box6"></div>
				<div class="box filter_box6"><h1 id="name_box6">City</h1></div>
		<div class="box overview_box7"></div>
				<div class="box filter_box7"><h1 id="name_box7">Niagarafälle</h1></div>
		<div class="box overview_box8"></div>
				<div class="box filter_box8"><h1 id="name_box8">Wüste</h1></div>
		<div class="box overview_box9"></div>
				<div class="box filter_box9"><h1 id="name_box9">Paris</h1></div>
    </div>
